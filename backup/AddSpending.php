...
$queryResult="SELECT code,COUNT(*) AS codeCount,SUM(amount) AS Total,MAX(amount) AS Maximum FROM spending where  date = $todate group by code";
...
<table width="100%">
	...
	<tr>
    <td align="left">
	<select name="whospend" id="whospend" style="font-size:60px;border-color:#ff0000 #0000ff;border-width: 7px;">
    ...
    <td align="right">
	<select name="code" id="code" class="reqd"  style="font-size:60px;border-color:#ff0000 #0000ff;border-width: 7px;">
	...
	<input type="text" name="amount" id="amount" size="5" maxlength="5" style="font-size:100px;text-align:left;border-style: solid;border-color:#ff0000 #0000ff;border-width: 7px;">
	</td>
	</tr>
	<tr>
	...
	<input type="image" src="images/more.jpg" name="more" value="more" onclick="window.open( 'MySpending.php', '_top');return false;"><br/>
...
echo "Total Spend today: <font color = red><b>\$$GrandTotal</b></font><br/>";
