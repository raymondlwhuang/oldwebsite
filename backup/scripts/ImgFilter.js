...
function PictureFilter() {
	...
	imgEffect=imgEffect+",";
		...
		$('#loadimg').html('<img src="ImgFilter.php?time_x='+new Date().getTime()+'&filename='+filename + '&imgEffect='+imgEffect + '&Contrast='+Contrast + '&Brightness='+Brightness + '" width="640"'+'id="profile" />');
