...
function PictureRotation() {
	...
	if(radius==0) {
		...
		cur_img="ImgAngleControl.php?time_x="+new Date().getTime()+"&filename="+document.getElementById("cur_picture").value + "&degrees="+degrees + "&toNewPic="+toNewPic3 + '&beforAddText='+beforAddText;
		/*
		if(document.getElementById("doResize").checked) {
		...
		cur_img="ImgRoundCorner.php?time_x="+new Date().getTime()+"&filename="+document.getElementById("cur_picture").value + "&degrees="+degrees + "&toNewPic="+toNewPic3 + '&beforAddText='+beforAddText + "&radius="+radius + "&topleft="+topleft + "&bottomleft="+bottomleft + "&bottomright="+bottomright + "&topright="+topright;
