...
if(isset($_REQUEST['filename'])) {
	if (isset($_REQUEST['filename'])) $filename = $_REQUEST['filename']; // text to display
	if (isset($_REQUEST['x'])) $x = (int)$_REQUEST['x']; // font to use (include directory if needed).
	if (isset($_REQUEST['y'])) $y = (int)$_REQUEST['y']; // fontsize in points
	if (isset($_REQUEST['cropWidth'])) $cropWidth = (int)$_REQUEST['cropWidth']; // cropWidth
	if (isset($_REQUEST['cropHeight'])) $cropHeight = (int)$_REQUEST['cropHeight']; // cropHeightding in pixels around text.
