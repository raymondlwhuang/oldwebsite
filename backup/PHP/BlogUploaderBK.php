...
$vRes = mysql_query("SELECT * FROM `upload_infor` where user_id=$GV_id and description = '$description' and upload_date='$today' limit 1");
if (mysql_num_rows($vRes) == 0){
	mysql_query("INSERT INTO upload_infor(user_id,description,upload_date) VALUES($GV_id,'$description','$today')");
}
if(!isset($description)) $description ="";
$queryUploadID="SELECT id FROM upload_infor where user_id=$GV_id and description = '$description' and upload_date='$today' limit 1";
