...
<a href="../HTML/FileMaintenance.html" target="_top">Photo/Video Maintenance</a><br/>
...
<a href="" onClick="SendRequest ('../PHP/LastActivity.php','maincontent');refreshiframe('$name[$key]','$FriendEmail[$key]','$value','$show_id');return false;"><img src='$value' width='67'/></a><br/><font size='2'>$name[$key]</font><br/>
STRINGBEGIN;
echo $longstring;
}
...
?>	
	...
	<td valign="top">
		<iframe src="PictureSlide.php" height="500" width="160" id="frame1" frameborder=0 SCROLLING=auto>
...
<script type="text/javascript" >
    ...
    {  
		...
		document.getElementById('frame1').src="PictureSlide.php?name="+name+"&FriendEmail="+document.getElementById('FriendEmail').value ;
