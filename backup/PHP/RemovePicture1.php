...
$queryPicture="SELECT * FROM picture_video where picture_video = 'pictures' and ((name like '$PicturePath%' and owner_path <> '$GV_owner_path') or owner_path = '$GV_owner_path') group by upload_id desc";  // query string stored in a variable
...
<?php
echo <<<_END
<iframe src="RemovePicture.php?show_id=$show_id" width="134" height="410" id="frame1" frameborder=0 SCROLLING=no style="position:absolute;top:200px;z-index:-1;">
