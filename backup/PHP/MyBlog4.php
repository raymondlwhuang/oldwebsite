...
<tr>
	<td valign="top" width="470" height="520">
	<?php
if(isset($_GET['FriendEmail'])) {
$FriendEmail = $_GET['FriendEmail'];
$longstring = <<<STRINGBEGIN
	<iframe src="ShowPictures.php?FriendEmail=$FriendEmail" width="470" height="100%"  frameborder=0 SCROLLING=no>
...
$longstring = <<<STRINGBEGIN
	<iframe src="ShowPictures.php" width="470" height="100%"  frameborder=0 SCROLLING=no>
	  <p>Your browser does not support iframes.</p>
	</iframe>
STRINGBEGIN;
echo $longstring;	
...
<tr>
	<td width="470">
		<iframe src="VideoMain.php" width="470" height="380" frameborder=0>
		  <p>Your browser does not support iframes.</p>
		</iframe>	
	</td>
</tr>
