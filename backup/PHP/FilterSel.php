...
<div style="font-size:9px;vertical-align:top;">
	<table width="100%">
	<tr>
	<td align="right">
	...
	<td align="right">
	<input type="image" src="../images/edit.png" style="border: 5px grey double;" onclick="window.open('EditPicture.php?thisPicture='+document.getElementById('thisPicture').value,target='_top');" /> </td>
	</tr>
	</table>
</div>
