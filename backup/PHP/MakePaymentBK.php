...
//	$fq_amount = $e->new_decode("$expenses");
	...
	if($frequency_id==2) {
		...
		if($item_id != 77) {
			mysql_query("INSERT INTO spending(user_id,category_id,item_id,expenses,date,paid_date,spender_id,type_id,bank_id,paid) VALUES($user_id,$category_id,$item_id,'$expenses',NOW(),NOW(),$spender_id,$type_id,$bank_id,1)");
		}
		else {
			mysql_query("INSERT INTO spending(user_id,category_id,item_id,expenses,date,paid_date,spender_id,type_id,bank_id,paid) VALUES($user_id,$category_id,$item_id,'$$expenses_neg',NOW(),NOW(),$spender_id,$type_id,$bank_id,1)");
			mysql_query("INSERT INTO spending(user_id,category_id,item_id,expenses,date,paid_date,spender_id,type_id,bank_id,paid) VALUES($user_id,$category_id,$item_id,'$expenses',NOW(),NOW(),$spender_id,$type_id,$to_bank_id,1)");
		}
	...
	elseif($frequency_id==3) {
		...
		$adday = $j * 7;
		$newdate = strtotime ( "+$adday day" , strtotime ( $reupdate_date )) ;
		$activated = date('Y-m-d', $newdate);
	}
	...
	elseif($frequency_id==5) {
		...
		$last_activated_date = strtotime ($reupdate_date);
		$activated = date('Y-m-d', $newdate);
