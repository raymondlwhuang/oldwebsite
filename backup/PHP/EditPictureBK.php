...
if(isset($_REQUEST['org_picture'])) $org_picture=mysql_real_escape_string($_REQUEST['org_picture']);
...
$CropPic=$targetfilepath."temp".$tempname.".".$ext[1];
$firstPic=$targetfilepath."temp5".$tempname.".".$ext[1];
$toNewPic=$targetfilepath."temp1".$tempname.".".$ext[1];
$toNewPic2=$targetfilepath."temp2".$tempname.".".$ext[1];
$toNewPic3=$targetfilepath."temp3".$tempname.".".$ext[1];
$toNewPic4=$targetfilepath."temp4".$tempname.".".$ext[1];
$beforAddText=$targetfilepath."beforAddText".$tempname.".".$ext[1];
