...
class ImageOnImage{
 var $firstImgSrc,$firstImage,$secondImgSrc,$secondImage,$firstImgWidth,$firstImgHeight,$secondImgWidth,$secondImgHeight,$ratio,$secondNewWith,$secondNewHeight,$SecondImageSmall; 
	...
	{
	   imagecopymerge($this->firstImage, $this->SecondImageSmall, $Xposition, $Yposition, 0, 0, $this->secondNewWith, $this->secondNewHeight, $pct); 
