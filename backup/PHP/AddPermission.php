...
<table>
	...
	echo <<<_END
	<li><a href="" onClick="document.getElementById('addemail').style.display='none';clearfield('$optionPicture[$id]','$optionName[$id]','$friendemail');document.getElementById('searchField').focus();return false;"><img src='$optionPicture[$id]'  width='50px'/></a>$optionName[$id]</li>
_END;
