<?php
require_once 'getPin2.php';
if(isSet($_POST['submit_x']))
{
include_once 'setPin.php';
}
?>
...
<body>
<div id="mydiv">
	<input type="image" name="close" src="../images/close_icon.png" width="39" style="float:right;" onclick="window.open('HERecorder.php',target='_top');"></td>
	...
	<tr>
	  <td align="center" colspan="2">
			...
			<input type="image" src="../images/change.png" name="change" alt="Change Pin" value="Change Pin" width="80" onClick="window.open('ChangePin.php',target='_top');return false;">
	  </td>
	</tr>
	</tbody>
	</table>
